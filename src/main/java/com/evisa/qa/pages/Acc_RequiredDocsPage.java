...
public class Acc_RequiredDocsPage extends EvisaBase {

	@FindBy(id = "nextSubmit")
	WebElement NxtBtn;

	public Acc_RequiredDocsPage() {
	...
	public Acc_ConfirmDetailPage UploadDocsPage() throws InterruptedException {
		...
		NxtBtn.click();
		return new Acc_ConfirmDetailPage();
	}
