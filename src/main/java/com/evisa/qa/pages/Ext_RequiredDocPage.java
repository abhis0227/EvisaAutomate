...
public class Ext_RequiredDocPage extends EvisaBase {

	@FindBy(id = "submitattachments")
	WebElement Next;

	public Ext_RequiredDocPage() {
	...
	public Ext_ConfimApplicantPage Ext_UploadDocsPage() throws InterruptedException {
		...
		Next.click();
		return new Ext_ConfimApplicantPage();
	}
