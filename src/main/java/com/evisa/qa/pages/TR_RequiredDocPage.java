...
public class TR_RequiredDocPage extends EvisaBase {

	@FindBy(id = "submitattachments")
	WebElement NxtBtn;

	public TR_RequiredDocPage() {
	...
	public TR_ConfirmDetailPage UploadDocsPage() throws InterruptedException {
		...
		NxtBtn.click();
		return new TR_ConfirmDetailPage();
	}
}
